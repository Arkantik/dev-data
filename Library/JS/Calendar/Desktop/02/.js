...
function renderControls(target, year, month) {
	...
	prevIcn.setAttributeNS(
		"http://www.w3.org/1999/xlink",
		"xlink:href",
		"#arrow"
	);
	nextIcn.setAttributeNS(
		"http://www.w3.org/1999/xlink",
		"xlink:href",
		"#arrow"
	);
	...
	prevBtn.setAttribute(
		"class",
		"calendar__controls__button svg-icon fill--white"
	);
	todayBtn.setAttribute(
		"class",
		"calendar__controls__button svg-icon stroke--white"
	);
	nextBtn.setAttribute(
		"class",
		"calendar__controls__button svg-icon fill--white svg-icon--rotated-180"
	);
	...
	title.innerHTML =
		'<span class="calendar__controls__button__year">' +
		year +
		" .</span>" +
		monthNames[month];
...
function goToday() {
	calendarTbody.setAttribute(
		"class",
		"calendar__tbody calendar__tbody--animate"
	);
	setTimeout(function () {
		newMonth(year, month);
	}, 450);
	...
	for (var i = 1; i < days + startDay; i++) {
		...
		if (i >= startDay) {
			...
			timeTag.setAttribute(
				"datetime",
				thisYear + "-" + formatMonth + "-" + (i - startDay)
			);
